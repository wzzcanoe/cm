...
public class ColumnContentNotExistException extends NotExistException {
	...
	public ColumnContentNotExistException(long productId, long columnId, long contentId) {
		super(ColumnContent.class, String.format("%d:%d:%d", productId, columnId, contentId));
	}
